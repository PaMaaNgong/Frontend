...
interface CommentDetailProp {
  ...
  examination_format: Array<string>;
  examimation_difficulty: string;
  exercise_format: Array<string>;
  ...
  return (
    <div>
      <Card className="maxWidth-3/4 mb-5">
        <CardContent className="flex grid-cols-2 col-start-1 col-end-2 gap-x-[1em]">
          ...
          <div className="flex flex-col items-end text-orange-300">
            ...
            <Chip
              label={
                grading_method.length === 2
                  ? grading_method[0] + " & " + grading_method[1]
                  : grading_method.length === 1
                  ? grading_method[0]
                  : "none"
              }
              className="w-3/6"
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>{classroom_environment}</Typography>
            <Typography paragraph>Detail:</Typography>
            <Typography paragraph>
              - Exercise: <br />
              {"  "} o Format: {exercise_format[0]} <br />
              {"  "} o Difficulty: {exercise_difficulty} <br />
              - Exam: <br />
              {"  "} o Format: {examination_format[0]} <br />
              {"  "} o Difficulty: {examimation_difficulty}
            </Typography>
          </CardContent>
        </Collapse>
      </Card>
